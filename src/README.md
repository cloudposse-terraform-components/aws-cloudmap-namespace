...
| <a name="input_description"></a> [description](#input\_description) | Description of the Cloud Map Namespace | `string` | n/a | yes |
...
| <a name="input_type"></a> [type](#input\_type) | Type of the Cloud Map Namespace | `string` | `"http"` | no |
